...
function test_split()
  @testset "Split" begin
    @test _split("[[[[0,7],4],[15,[0,13]]],[1,1]]") == "[[[[0,7],4],[[7,8],[0,13]]],[1,1]]"
    @test _split("[[[[0,7],4],[[7,8],[0,13]]],[1,1]]") == "[[[[0,7],4],[[7,8],[0,[6,7]]]],[1,1]]"
  end
end

function test_add()
  @testset "Add" begin
    @test _add("[[[[4,3],4],4],[7,[[8,4],9]]]", "[1,1]") == "[[[[[4,3],4],4],[7,[[8,4],9]]],[1,1]]"
  end
end

function test_all()
  @testset "Full example" begin
    s = _add("[[[[4,3],4],4],[7,[[8,4],9]]]", "[1,1]")
...
function test_lists()
  @testset "Reduce list" begin
    ...
    @test _reduce(a3) == "[[[[1,1],[2,2]],[3,3]],[4,4]]"
  end
end
